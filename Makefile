...
SRC					=	main.c \
						...
						render_utils.c \
						sphere.c \
						matrices_utils.c matrices_multiplications.c matrices_translations.c  matrices_inversions.c matrices_transpositions.c matrices_scaling.c matrices_shearing.c \
						utils.c \
						color_operations.c \
						free_utils.c \
