...
// 		// }
// 		// else if (minirt->ui->selected_type == AMB)
// 		// {
// 		// 	if (minirt->scene->ambient->brightness <= 0.9)
// 		// 	{
// 		// 		minirt->scene->ambient->brightness += 0.05;
// 		// 		set_object_ambient_light(minirt->scene);
// 		// 	}
// 		// 	return ;
// 		// }
// 		// else
// 		// {
// 		// 	minirt->scene->lights[minirt->ui->selected_object - minirt->scene->nb_objects]->pos.y += 0.1;
// 		// 	return ;
// 		// }
// 	}
...
void	event_handle_pavnum(t_minirt *minirt, int keycode)
{
	...
	if (minirt->ui->move_mode == pos)
		...
		change_element_size(minirt, minirt->ui, keycode, i);
